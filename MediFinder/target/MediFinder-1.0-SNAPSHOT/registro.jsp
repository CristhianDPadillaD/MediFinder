    ...
    <form id="registroForm" action="SvAgregarSolicitud" method="POST" enctype="multipart/form-data" oninput="actualizarProgreso()" onsubmit="return validarFormulario()">
      <div class="form-grid">
        <div class="form-column">
          <input type="text" id="nombre" placeholder="Nombre de la Farmacia" required>
        ...
        <div class="form-column" >
          <input type="tel" id="telefono" placeholder="Teléfono" required>
           <select id="representanteLegal" required>
            <option value="">Representante Legal</option>
            <option>Luisa Maria Rivadeneria</option>
          </select>
          <label for="camara">Registro Cámara de Comercio</label>
          <input type="file" id="camara" required>
          <label for="licencia">Licencia de Funcionamiento</label>
          <input type="file" id="licencia" required>
          <label for="registroSanitario">Registro Sanitario</label>
          <input type="file" id="registroSanitario" required>
          <input type="text" id="comentario" placeholder="Comentarios adicionales">
        </div>
      </div>
